...
namespace HotelReservation {
    ...
    public partial class HotelDataSet9 : global::System.Data.DataSet {
        ...
        public partial class ReservationDataTable : global::System.Data.TypedTableBase<ReservationRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ReservationRow AddReservationRow(string ClientName, string RoomNumber) {
...
namespace HotelReservation.HotelDataSet9TableAdapters {
    ...
    public partial class ReservationTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Reservation] WHERE (([Id] = @Original_Id) AND ((@IsNull_Client" +
                "Name = 1 AND [ClientName] IS NULL) OR ([ClientName] = @Original_ClientName)) AND" +
                " ((@IsNull_RoomNumber = 1 AND [RoomNumber] IS NULL) OR ([RoomNumber] = @Original" +
                "_RoomNumber)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Reservation] ([ClientName], [RoomNumber]) VALUES (@ClientName," +
                " @RoomNumber);\r\nSELECT Id, ClientName, RoomNumber FROM Reservation WHERE (Id = S" +
                "COPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Reservation] SET [ClientName] = @ClientName, [RoomNumber] = @RoomNumber WHERE (([Id] = @Original_Id) AND ((@IsNull_ClientName = 1 AND [ClientName] IS NULL) OR ([ClientName] = @Original_ClientName)) AND ((@IsNull_RoomNumber = 1 AND [RoomNumber] IS NULL) OR ([RoomNumber] = @Original_RoomNumber)));
SELECT Id, ClientName, RoomNumber FROM Reservation WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, ClientName, RoomNumber FROM dbo.Reservation";
        ...
        public virtual int Fill(HotelDataSet9.ReservationDataTable dataTable) {
        ...
        public virtual HotelDataSet9.ReservationDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            HotelDataSet9.ReservationDataTable dataTable = new HotelDataSet9.ReservationDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(HotelDataSet9.ReservationDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_ClientName, string Original_RoomNumber) {
        ...
        public virtual int Insert(string ClientName, string RoomNumber) {
            if ((ClientName == null)) {
        ...
        public virtual int Update(string ClientName, string RoomNumber, int Original_Id, string Original_ClientName, string Original_RoomNumber, int Id) {
            if ((ClientName == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ClientName, string RoomNumber, int Original_Id, string Original_ClientName, string Original_RoomNumber) {
            return this.Update(ClientName, RoomNumber, Original_Id, Original_ClientName, Original_RoomNumber, Original_Id);
        }
    }
